...
public class FormLocatorsPage {
    ...
    public By registrationAPointButton = By.xpath("//*[@id=\"root\"]/div/main/div/form/button");
    ...
    public By passwordEnter = By.xpath("//*[@id=\"root\"]/div/main/div/form/fieldset[3]/div/div/input");//Ввод пароля в форме Вход
    ...
    public By textEnterToArea = By.xpath("//*[text()='Вход']"); //текст формы Вход
    ...
    private final By wrongPassword = By.xpath(".//div[@class='input__container']/p[text()='Некорректный пароль']");// неправильный пароль
    ...
    public void clickSauceShowcaseButton() {
        driver.findElement(sauceShowcaseButton).click();
    ...
    public String getTextRegistrationAPointButton() {
        return driver.findElement(wrongPassword).getText();
    }

    public void clickRegistrationAPointButton() {
        driver.findElement(wrongPassword).click();
    }
}